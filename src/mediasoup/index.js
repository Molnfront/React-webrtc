...
const getMediaStream = async () => {
  let mediaStream;
  if (streamFromVideojs) {
    mediaStream = streamFromVideojs;
  } else {
    mediaStream = await GUM();
  }

  // const mediaStream = streamFromVideojs;
...
export const initialise = (videoStream) => {
  streamFromVideojs = videoStream;
  socket = new WebSocket(`wss://capture.thedarkhorse.ai`);
